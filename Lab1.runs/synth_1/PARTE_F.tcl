...
set_property used_in_implementation false [get_files C:/Xilinx_clase/Lab1/Lab1.srcs/constrs_1/new/parte_f_constraint.xdc]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

synth_design -top PARTE_F -part xc7z020clg484-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef PARTE_F.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file PARTE_F_utilization_synth.rpt -pb PARTE_F_utilization_synth.pb"
