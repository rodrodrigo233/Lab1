...
synth_design -top pwm_8 -part xc7z020clg484-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef pwm_8.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file pwm_8_utilization_synth.rpt -pb pwm_8_utilization_synth.pb"
