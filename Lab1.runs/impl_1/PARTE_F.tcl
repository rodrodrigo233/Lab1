...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache C:/Users/pc/AppData/Roaming/Xilinx/Vivado/.Xil/Vivado-9796-DESKTOP-3K9NM8F/incrSyn
  ...
  add_files -quiet C:/Xilinx_clase/Lab1/Lab1.runs/synth_1/PARTE_F.dcp
  read_xdc C:/Xilinx_clase/Lab1/Lab1.srcs/constrs_1/new/parte_f_constraint.xdc
  link_design -top PARTE_F -part xc7z020clg484-1
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force PARTE_F_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file PARTE_F_drc_opted.rpt -pb PARTE_F_drc_opted.pb -rpx PARTE_F_drc_opted.rpx"
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force PARTE_F_placed.dcp
  create_report "impl_1_place_report_io_0" "report_io -file PARTE_F_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file PARTE_F_utilization_placed.rpt -pb PARTE_F_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file PARTE_F_control_sets_placed.rpt"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force PARTE_F_routed.dcp
  create_report "impl_1_route_report_drc_0" "report_drc -file PARTE_F_drc_routed.rpt -pb PARTE_F_drc_routed.pb -rpx PARTE_F_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file PARTE_F_methodology_drc_routed.rpt -pb PARTE_F_methodology_drc_routed.pb -rpx PARTE_F_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file PARTE_F_power_routed.rpt -pb PARTE_F_power_summary_routed.pb -rpx PARTE_F_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file PARTE_F_route_status.rpt -pb PARTE_F_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file PARTE_F_timing_summary_routed.rpt -pb PARTE_F_timing_summary_routed.pb -rpx PARTE_F_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file PARTE_F_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file PARTE_F_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file PARTE_F_bus_skew_routed.rpt -pb PARTE_F_bus_skew_routed.pb -rpx PARTE_F_bus_skew_routed.rpx"
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force PARTE_F_routed_error.dcp
...
set rc [catch {
  ...
  catch { write_mem_info -force PARTE_F.mmi }
  write_bitstream -force PARTE_F.bit 
  catch {write_debug_probes -quiet -force PARTE_F}
  catch {file copy -force PARTE_F.ltx debug_nets.ltx}
