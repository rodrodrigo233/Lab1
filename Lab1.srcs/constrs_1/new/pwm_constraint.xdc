...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {load}];  # "BTNC"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {DC[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {DC[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {DC[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {DC[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {DC[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {DC[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {DC[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {DC[7]}];  # "SW7"
