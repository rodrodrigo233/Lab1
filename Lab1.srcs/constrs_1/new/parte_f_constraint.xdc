...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y11  [get_ports {output}];  # "JA1"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {llave[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {llave[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {llave[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {llave[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {llave[4]}];  # "SW4"
